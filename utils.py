...
def map_and_filter(s, map_fn, filter_fn):
    ...
    # BEGIN Question 0
    "*** REPLACE THIS LINE ***"
    return [map_fn(i) for i in s if filter_fn(i)]       #return a list of values in s with filter_fn cond and applied map_fn on them
    # END Question 0
...
def key_of_min_value(d):
    ...
    # BEGIN Question 0
    "*** REPLACE THIS LINE ***"
    return min(d.keys(), key = lambda x: d[x])    #return the key of smallest item in dictionary d
    # END Question 0
