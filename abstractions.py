...
def make_restaurant(name, location, categories, price, reviews):
    ...
    return {
        ...
        'price': price,
        'reviews': [review_rating(review) for review in reviews]            #added this
    }
...
def restaurant_num_ratings(restaurant):
    ...
    # BEGIN Question 2
    "*** REPLACE THIS LINE ***"
    return len(restaurant_ratings(restaurant))          #return the number of elements in ratings of restaurant
    # END Question 2
...
def restaurant_mean_rating(restaurant):
    ...
    # BEGIN Question 2
    "*** REPLACE THIS LINE ***"
    return sum(restaurant_ratings(restaurant))/restaurant_num_ratings(restaurant)     #divide the sum by the number of ratings to get the mean rating.
    # END Question 2